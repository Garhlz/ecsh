...
mod stmt_tests {
    use crate::ecscript::eval::{
        EvalContext, ExecFlow, eval_expr, eval_module, eval_script, eval_script_with_io_ctx,
    };
    use crate::ecscript::module::ModuleLoader;
    use crate::ecscript::{
    ...
    fn eval_builtin_clone_breaks_array_aliasing() {
        let env = Environment::new();
        eval_script_src("let a = [1, 2, 3]; let b = clone(a); b[0] = 9;", &env).unwrap();
